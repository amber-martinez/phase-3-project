...
//         console.log(profileMatch.id)
//         fetch(`http://localhost:9292/users/${profileMatch.id}`, {
//             method: "DELETE",
//         })

//         setProfileJSX(<p>your account has been deleted.</p>)
//     }
...
//                         {editProfileClick ? null : <div onClick={onDeleteProfileClick}><p id="editProfileButton">delete profile</p></div>}
...
//     }, [profileState, loadedProfileData])
